        ...
        <div class="modal-content">
            ...
            <form id="saveStudent">
                <div class="modal-body">
                    ...
                    <!-- Image input with required attribute -->
                    <div class="mb-3">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <img id="view_img" src="" alt="img" class="img-fluid"/>
            </div>
                <div class="mb-3">
                    <label for="">Name</label>
                ...
                <div class="mb-3">
                    <label for="">StudentNo</label>
                    <p id="view_studentno" class="form-control"></p>
                </div>
                <div class="mb-3">
                    <label for="">Course</label>
...
<div class="container mt-4">
    ...
    <div style="border: 0px solid #ced4da; padding: 5px; border-radius: 5px;">
    <p style="text-align: right; margin: 0;">
        <a href="index.html" style="text-decoration: none; color: #dc3545; font-weight: bold;">Logout</a>
    </p>
</div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#studentno').val(res.data.studentno);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_studentno').text(res.data.studentno);
